...
import steamLogo from '../icons/steamLogo.png'
  ...
  const history = useHistory()
    ...
    return (
      <div style={{backgroundImage: `url(${bg})`, width: '100%', height: '100%'}}>
        ...
        <Container>
            <Grid>
              <Img src={CsLogo} alt="Logo_csgo"></Img>
              <Title>CSGO STATS</Title>
              <SubTitle>Les stats complètes de votre compte</SubTitle>
            </Grid>
            <div style={{display: "flex"}}>
              <Filter>
                <ImgLogo src={steamLogo} alt="steam_logo"></ImgLogo>
              </Filter>
              <SInput size="lg" placeholder="Pseudo..."></SInput>
              <GOButton onClick={() => history.push({pathname: `/csgo/${input}`})}>GO</GOButton>
            </div>
        </Container>
        </div>
    )
