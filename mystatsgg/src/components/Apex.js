...
import ApexLogo from '../icons/ApexLogo.png'
  ...
  const history = useHistory()
    ...
    return (
      <div style={{backgroundImage: `url(${bg})`, width: '100%', height: '100%'}}>
        ...
        <Container>
            <Grid>
              <Img src={ApexLogo} alt="Logo_lol"></Img>
            ...
            <div style={{display: "flex"}}>
              ...
              <SDropdown renderTitle={children => {return <SButton appearance="primary">{plat}</SButton>}}>
                <Dropdown.Item onSelect={() => setPlat('ORIGIN')}>Origin</Dropdown.Item>
              ...
              <GOButton onClick={() => history.push({pathname: `/apex/${input}`})}>GO</GOButton>
            </div>
        </Container>
        </div>
    )
